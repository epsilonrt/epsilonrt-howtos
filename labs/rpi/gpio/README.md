...
[piduino](https://github.com/epsilonrt/piduino), deux notions de base des
entrées-sorties numériques d'une carte Raspberry Pi : générer un signal PWM et
détecter un front par interruption.
